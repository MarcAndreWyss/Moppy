...
/*Serial data transmission rate in baud (bits per second) used for the
 communication with the Arduino microcontroller.
 */
const long SERIAL_DATA_TRANSMISSION_RATE = 9600;
...
void setup(){
  ...
  Serial.begin(SERIAL_DATA_TRANSMISSION_RATE);
}
